...
final pages = [
  new PageViewModel(
      ...
      'assets/mountain.png',
      'Você está pronto?',
      'Quando o teste começar, você irá ouvir algumas palavras...\n \n \n \n Deslize com o dedo para ir para a próxima página!',
      'assets/plane.png',
      false),
  new PageViewModel(
      ...
      'assets/world.png',
      'Basta clicar',
      'Quando ouvir a palavra reproduziada, apenas clique nela na tela do Tablet/Celular!',
      'assets/calendar.png',
      false),
  new PageViewModel(
